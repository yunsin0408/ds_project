...
public class YouTubeTranscriptFetcher {
    ...
    /**
     * Main method for testing the YouTubeTranscriptFetcher.
     * Tests the fetcher with sample YouTube URLs.
     */
    public static void main(String[] args) {
        System.out.println("=".repeat(60));
        System.out.println("         YouTube Transcript Fetcher - Test");
        System.out.println("=".repeat(60));
        System.out.println();
        System.out.println("NOTE: This requires Python 3 and youtube-transcript-api library.");
        System.out.println("Setup: Run ./setup_python.sh to create virtual environment");
        System.out.println();
        ...
        for (int i = 0; i < testUrls.length; i++) {
            System.out.println("\n" + "-".repeat(60));
            System.out.println("Test " + (i + 1) + ": " + testUrls[i]);
            System.out.println("-".repeat(60));
            
            String transcript = fetchTranscript(testUrls[i]);
            
            if (!transcript.isEmpty()) {
                System.out.println("\n[SUCCESS] Transcript Preview (first 500 chars):");
                System.out.println("-".repeat(60));
                if (transcript.length() > 500) {
                    System.out.println(transcript.substring(0, 500) + "...");
                } else {
                    System.out.println(transcript);
                }
                System.out.println("\n" + "-".repeat(60));
                System.out.println("Total length: " + transcript.length() + " characters");
                
                // Show word count for keywords
                String[] keywords = {"ISO", "Standard", "Sustain", "Certificate"};
                System.out.println("\nKeyword occurrences:");
                for (String keyword : keywords) {
                    int count = countOccurrences(transcript, keyword);
    ...
    /**
     * Helper method to count case-insensitive occurrences of a keyword in text.
     */
